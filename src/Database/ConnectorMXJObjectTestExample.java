...
public class ConnectorMXJObjectTestExample {
    ...
    public ConnectorMXJObjectTestExample() throws ClassNotFoundException, SQLException, InterruptedException{
        ...
        ConnectorMXJObjectTestExample.mysqldResource = startDatabase(databaseDir, port,
                userName, password);
        ...
        try {
            ...
            try {
                if (conn != null) {
                    ConnectorMXJObjectTestExample.mConnection = conn;
                    //conn.close();
                }
    ...
    public MysqldResource getMysqldResource(){return ConnectorMXJObjectTestExample.mysqldResource;}
